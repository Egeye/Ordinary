...
import com.octavio.ordinary.model.SpecialCalendar;
...
/**
 * calendar 日历gridview中的每一个item显示的textview
 * @author Octavio
 *
 */
...
//	private ScheduleDAO dao = null;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.activity_calendar_subject1, null);
		}
...
//				textView.setTextColor(Color.BLACK);//008080
				textView.setTextColor(Color.rgb(80, 155, 229));
		...
		if (currentFlag == position) {
			...
			drawable = res.getDrawable(R.drawable.current_day_bgc1);
			textView.setBackgroundDrawable(drawable);
...
//			textView.setTextColor(Color.rgb(255, 145, 90));
	...
	public void getCalendar(int year, int month) {
		...
		Log.d("DAY", isLeapyear + " ======  " + daysOfMonth + "  ============  " + firstDayOfMonth + "  =========   "
				+ lastDaysOfMonth);
		getweek(year, month);
	}
